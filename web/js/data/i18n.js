...
const MESSAGES = {
  zh: {
    ...
    'card.perception.cable_hint': 'perception_state · cable_object_pose · base_link',
    'card.perception.target_sensor_label': '目标物（TargetSensor）',
    'card.perception.target_sensor_hint': 'perception_state · target_sensor_object_pose · base_link',
    ...
    'card.perception.cable_table_caption': '缆绳目标（base_link）',
    'card.perception.target_table_caption': 'TargetSensor 多目标（/target_set，侧抓系）',
    'card.perception.target_insert_holes_caption': '固定7插孔（/target_insert_holes，base_link）',
  ...
  en: {
    ...
    'card.perception.table_id': 'ID',
    'card.perception.cable_table_caption': 'Cable target (base_link)',
    'card.perception.target_table_caption': 'TargetSensor targets (/target_set, side grasp)',
    'card.perception.target_insert_holes_caption': 'Fixed 7 insert holes (/target_insert_holes, base_link)',
