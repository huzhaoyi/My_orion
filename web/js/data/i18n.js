...
const MESSAGES = {
  zh: {
    ...
    'right.pick_target_sensor_title': 'perception_state.target_sensor_object_pose → submit_job LEGACY（与 TargetSensor 桥接一致）',
  ...
  en: {
    ...
    'right.pick_target_sensor_title': 'perception_state.target_sensor_object_pose → submit_job LEGACY',
