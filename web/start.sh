...
if [ -f "$REPO_ROOT/src/orion_description/target_new.stl" ]; then
  cp -u "$REPO_ROOT/src/orion_description/target_new.stl" "$SCRIPT_DIR/robot/meshes/stl/target_new.stl"
fi
