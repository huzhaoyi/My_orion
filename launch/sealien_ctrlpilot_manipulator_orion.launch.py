...
本 launch 合并 panel_obstacles 进 orion_mtc_node，并写入 target_sensor_to_object_pose 参数，使面板 Marker 与 /manipulator/target_insert_holes 同 stamp 发布。
"""
import copy
import os
import tempfile
...
def generate_launch_description():
    ...
    从本包 config/default.yaml 读取 launch 默认；MTC 节点参数来自 orion_mtc_params.yaml。
    """
    ...
    arg_use_joy = DeclareLaunchArgument(
        ...
        description=(
            "true：启动 orion_joy_arm_bridge；默认取自 share/sealien_ctrlpilot_manipulator_orion/config/default.yaml"
        ),
    )
