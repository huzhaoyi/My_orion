...
#include "sealien_ctrlpilot_manipulator_orion_mtc/app/sealien_ctrlpilot_manipulator_orion_mtc_node.hpp"
...
static const rclcpp::Logger LOGGER = rclcpp::get_logger("sealien_ctrlpilot_manipulator_orion_mtc");
...
/*
 * 双节点构造：sealien_ctrlpilot_manipulator_orion_mtc_node 承载参数与 FeasibilityChecker；action_client 承载订阅/服务/TF。
...
OrionMTCNode::OrionMTCNode(const rclcpp::NodeOptions& options)
  : node_(std::make_shared<rclcpp::Node>("sealien_ctrlpilot_manipulator_orion_mtc_node", options))
  , action_client_node_(std::make_shared<rclcpp::Node>("sealien_ctrlpilot_manipulator_orion_mtc_action_client", options))
{
...
void OrionMTCNode::initModules()
{
    ...
    task_manager_->setGetLatestTargetSetCallback(
        [this]() { return target_cache_ ? target_cache_->latest() : std::optional<sealien_ctrlpilot_manipulator_orion_mtc_msgs::msg::TargetSet>(); });
    ...
    manipulator_tf_node_ = std::make_shared<rclcpp::Node>("sealien_ctrlpilot_manipulator_orion_mtc_manip_tf", manip_tf_opts);
...
/* MultiThreadedExecutor：action_client 承载订阅/服务/TF；sealien_ctrlpilot_manipulator_orion_mtc_node 承载 FeasibilityChecker 的 joint_states 等。 */
