 ...
 */
void TargetCache::update(const sealien_ctrlpilot_manipulator_orion_mtc_msgs::msg::TargetSet& msg)
{
 ...
 */
std::optional<sealien_ctrlpilot_manipulator_orion_mtc_msgs::msg::TargetSet> TargetCache::latest() const
{
    std::lock_guard<std::mutex> lock(mutex_);
    if (!has_data_)
    {
