...
#include "sealien_ctrlpilot_manipulator_orion_mtc/config/runtime_policy.hpp"
...
#include "sealien_ctrlpilot_manipulator_orion_mtc/orchestration/manipulation_state_machine.hpp"
...
private:
  ...
  std::function<std::optional<sealien_ctrlpilot_manipulator_orion_mtc_msgs::msg::TargetSet>()> get_latest_target_set_fn_;
