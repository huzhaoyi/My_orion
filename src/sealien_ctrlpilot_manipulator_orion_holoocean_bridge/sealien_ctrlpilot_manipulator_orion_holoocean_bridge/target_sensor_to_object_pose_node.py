...
from sealien_ctrlpilot_manipulator_orion_mtc_msgs.msg import PerceptionState, TargetSet
...
def _panel_aabb_box_marker(
    ...
    """
    与 sealien_ctrlpilot_manipulator_orion_mtc makePanelBoxCollisionObject 一致：AABB + 退化维钳到 wall_thickness + margin。
