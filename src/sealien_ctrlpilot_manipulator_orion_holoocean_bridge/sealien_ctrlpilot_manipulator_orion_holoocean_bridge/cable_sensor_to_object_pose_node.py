...
from sealien_ctrlpilot_manipulator_orion_mtc_msgs.msg import PerceptionState
...
class CableSensorToObjectPoseNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self._last_axis_direction_base: Optional[np.ndarray] = None
    ...
    def _publish_perception_state(self, stamp) -> None:
        ...
        if self._last_axis_direction_base is not None:
            ...
            ps.object_axis_direction.z = float(self._last_axis_direction_base[2])
        else:
            ps.object_axis_direction.x = 0.0
    ...
    def _on_cable_sensor(self, msg: CableSensor) -> None:
        ...
        self._last_axis_direction_base = d_base.copy()
