...
MTC/sealien_ctrlpilot_manipulator_orion_mtc 可能对两臂控制器并行发送 goal；默认单线程 spin 会导致第二个 execute
...
# 与 sealien_ctrlpilot_manipulator_orion_moveit_config / arm_sensor 一致的关节名，用于按名从 trajectory 中取位置（RViz 下发顺序可能不同）
ARM_JOINT_NAMES = [
